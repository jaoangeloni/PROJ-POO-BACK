...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User weslley = new User(null, "Weslley", "weslley@gmail.com", "123");
		User rafael = new User(null, "Rafael", "rafael@gmail.com", "123");
		User victor = new User(null, "Victor", "victor@gmail.com", "123");
